...
import com.student.profile.help.ResourceNotFoundException;
...
public class StudentServiceImpl implements StudentService {
	...
	@Override
	public Student saveStudentRest(Student student) {
	...
	public Student getStudentById(long id) {
		return studentRepo.findById(id).orElseThrow(() -> new ResourceNotFoundException("Employee", "Id", id));
	}
}